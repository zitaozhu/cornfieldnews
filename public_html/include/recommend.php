...
$sql = " SELECT title, nid, date FROM news
WHERE news.category = 
(SELECT DISTINCT(category) FROM news 
INNER JOIN likes ON likes.nid = news.nid
AND likes.email = '2@b.com') ORDER BY date LIMIT 5";
//Run the Query
	...
	<table class="data-table">
		...
		while ($row = mysqli_fetch_array($result))
		{
			...
			echo '<tr>
                    ...
                    <td><a href="http://cornfieldnews.web.engr.illinois.edu/search_detail.php?newsid='.$nid.'">'.$nid.'</a> </td>
				</tr>';
			$no++;
		}?>
		</tbody>
