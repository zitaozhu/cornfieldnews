...
$number = $_GET['number'];
$isGeneral = $_GET['isGeneral'];
$isPolitics = $_GET['isPolitics'];
$isSport = $_GET['isSport'];
$isDate = $_GET['isDate'];
echo $keyword;
echo $number;
echo $isGeneral;
...
//Setup our query
if ($isGeneral !='on' and  $isPolitics !='on' and  $isSport !='on' ){
    echo("error");
}
...
$sql = "SELECT * FROM news WHERE title LIKE '%$keyword%'
        AND (category = '$general'  OR category = '$sport' OR category = '$politic') ";
